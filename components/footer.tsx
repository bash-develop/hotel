...
function Footer() {
  return (
    <div className="border-t-1 bg-black/90 py-4 w-full  text-white text-center flex flex-col md:flex-row items-center justify-between lg:px-5 px-2">
      <div className="sm:text-left text-center">
        <span className="block text-center"> Отель София</span>
      ...
      <div className="">
        <span>Создано:</span> <a href="https://shankin.dev">shankin.dev</a>
      </div>
    </div>
  );
}
